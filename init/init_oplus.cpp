...
constexpr const char* TMO_BUILD_DESCRIPTION = "RMX2195-user 11   release-keys";
constexpr const char* TMO_BUILD_FINGERPRINT = "realme/RMX2195/RMX2195:11/RKQ1.201217.002/2310131958:user/release-keys";
constexpr const char* METRO_BUILD_DESCRIPTION = "RMX2195-user 11   release-keys";
constexpr const char* METRO_BUILD_FINGERPRINT = "realme/RMX2195/RMX2195:11/RKQ1.201217.002/2310091801:user/release-keys";
...
void OverrideCarrierProperties(int prjname) {
    ...
    for (const auto& source : RO_PROP_SOURCES) {
        if (prjname == 20880) {
            ro_prop_override(source, "model", "RECE4244", true);
            ro_prop_override(source, "device", "RMX2195", true);
    ...
    if (prjname == 20880) {
        ro_prop_override(nullptr, "product", "RMX2195", false);
